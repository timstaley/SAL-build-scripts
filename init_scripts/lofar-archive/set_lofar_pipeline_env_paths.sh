...
export PATH=${PATH:+${PATH}:}${collated_paths_folder}/bin 
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH:+${LD_LIBRARY_PATH}:}${collated_paths_folder}/lib
export PYTHONPATH=${PYTHONPATH:+${PYTHONPATH}:}${collated_paths_folder}/python-packages
